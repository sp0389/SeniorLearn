...
namespace SeniorLearn.Migrations
{
    ...
    [Migration("20240930130048_EnrolmentUpdate")]
    partial class EnrolmentUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SeniorLearn.Data.OrganisationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3ce9c3e2-e3c4-4dbe-8c9e-ae5aeabbd654",
                            Name = "Administrator",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "293a1bc1-53d0-4bd7-b450-1b34b4fb6588",
                            Name = "Standard",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "4b13a951-d802-4135-9564-d125401848da",
                            Name = "Professional",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "eb006cb6-b22c-4fa8-8c04-e8602d294099",
                            Name = "Honorary",
            ...
            modelBuilder.Entity("SeniorLearn.Data.OrganisationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleType = 0,
                            StartDate = new DateTime(2024, 9, 30, 13, 0, 48, 91, DateTimeKind.Utc).AddTicks(8524)
                        },
                        new
                        {
                            UserId = "c6e5a515-b561-458a-85e6-ab9e7eed58f4",
                            RoleId = "1455a748-82ad-4e31-bb41-7c72cfc0fbfa",
                            EndDate = new DateTime(2025, 9, 30, 13, 0, 48, 91, DateTimeKind.Utc).AddTicks(8526),
                            RoleType = 1,
                            StartDate = new DateTime(2024, 9, 30, 13, 0, 48, 91, DateTimeKind.Utc).AddTicks(8526)
                        },
                        new
                        {
                            UserId = "7610170e-d0e7-43b9-a289-02d13056d54e",
                            RoleId = "de1e5fe5-585b-4867-aae8-57776d64f330",
                            EndDate = new DateTime(2025, 9, 30, 13, 0, 48, 91, DateTimeKind.Utc).AddTicks(8532),
                            RoleType = 2,
                            StartDate = new DateTime(2024, 9, 30, 13, 0, 48, 91, DateTimeKind.Utc).AddTicks(8531)
                        });
                });
            ...
            modelBuilder.Entity("SeniorLearn.Data.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Registered = new DateTime(2024, 9, 30, 13, 0, 48, 91, DateTimeKind.Utc).AddTicks(8490),
                        ...
                        new
                        {
                            ...
                            PhoneNumberConfirmed = false,
                            Registered = new DateTime(2024, 9, 30, 13, 0, 48, 91, DateTimeKind.Utc).AddTicks(8497),
                        ...
                        new
                        {
                            ...
                            PhoneNumberConfirmed = false,
                            Registered = new DateTime(2024, 9, 30, 13, 0, 48, 91, DateTimeKind.Utc).AddTicks(8502),
