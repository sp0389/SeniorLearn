...
namespace SeniorLearn.Migrations
{
    ...
    [Migration("20241017041523_AddUserStatus")]
            ...
            modelBuilder.Entity("SeniorLearn.Data.OrganisationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "c069a5d0-05dd-4e6c-a7e9-1c41c3177a84",
                            Name = "Administrator",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "28ef1af9-ecd1-400c-89ce-350fd70ce5a9",
                            Name = "Standard",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "79260364-afb7-470e-bf94-79d2e777ebd9",
                            Name = "Professional",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "dcb75c45-0f9e-4c91-9109-5b696df871dc",
                            Name = "Honorary",
            ...
            modelBuilder.Entity("SeniorLearn.Data.OrganisationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleType = 0,
                            StartDate = new DateTime(2024, 10, 17, 4, 15, 22, 637, DateTimeKind.Utc).AddTicks(8970)
                        },
                        new
                        {
                            UserId = "c6e5a515-b561-458a-85e6-ab9e7eed58f4",
                            RoleId = "1455a748-82ad-4e31-bb41-7c72cfc0fbfa",
                            EndDate = new DateTime(2025, 10, 17, 4, 15, 22, 637, DateTimeKind.Utc).AddTicks(8972),
                            RoleType = 1,
                            StartDate = new DateTime(2024, 10, 17, 4, 15, 22, 637, DateTimeKind.Utc).AddTicks(8971)
                        },
                        new
                        {
                            UserId = "7610170e-d0e7-43b9-a289-02d13056d54e",
                            RoleId = "de1e5fe5-585b-4867-aae8-57776d64f330",
                            EndDate = new DateTime(2025, 10, 17, 4, 15, 22, 637, DateTimeKind.Utc).AddTicks(8977),
                            RoleType = 2,
                            StartDate = new DateTime(2024, 10, 17, 4, 15, 22, 637, DateTimeKind.Utc).AddTicks(8976)
                        });
                });
            ...
            modelBuilder.Entity("SeniorLearn.Data.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Registered = new DateTime(2024, 10, 17, 4, 15, 22, 637, DateTimeKind.Utc).AddTicks(8933),
                        ...
                        new
                        {
                            ...
                            PhoneNumberConfirmed = false,
                            Registered = new DateTime(2024, 10, 17, 4, 15, 22, 637, DateTimeKind.Utc).AddTicks(8940),
                        ...
                        new
                        {
                            ...
                            PhoneNumberConfirmed = false,
                            Registered = new DateTime(2024, 10, 17, 4, 15, 22, 637, DateTimeKind.Utc).AddTicks(8948),
