...
namespace SeniorLearn.Migrations
{
    ...
    [Migration("20240924095058_AddConcurrency")]
            ...
            modelBuilder.Entity("SeniorLearn.Data.OrganisationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d148dd6b-a294-4d28-9b23-a329023f40d6",
                            Name = "Administrator",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "d463b7e0-7e21-44ac-a692-a213884989d6",
                            Name = "Standard",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "51ef888a-7964-4bd0-9436-9ec974d7c250",
                            Name = "Professional",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ea710c86-af2f-4fe9-acd0-dc22af8ac9a0",
                            Name = "Honorary",
            ...
            modelBuilder.Entity("SeniorLearn.Data.OrganisationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleType = 0,
                            StartDate = new DateTime(2024, 9, 24, 9, 50, 58, 64, DateTimeKind.Utc).AddTicks(1221)
                        },
                        new
                        {
                            UserId = "c6e5a515-b561-458a-85e6-ab9e7eed58f4",
                            RoleId = "1455a748-82ad-4e31-bb41-7c72cfc0fbfa",
                            EndDate = new DateTime(2025, 9, 24, 9, 50, 58, 64, DateTimeKind.Utc).AddTicks(1222),
                            RoleType = 1,
                            StartDate = new DateTime(2024, 9, 24, 9, 50, 58, 64, DateTimeKind.Utc).AddTicks(1222)
                        },
                        new
                        {
                            UserId = "7610170e-d0e7-43b9-a289-02d13056d54e",
                            RoleId = "de1e5fe5-585b-4867-aae8-57776d64f330",
                            EndDate = new DateTime(2025, 9, 24, 9, 50, 58, 64, DateTimeKind.Utc).AddTicks(1269),
                            RoleType = 2,
                            StartDate = new DateTime(2024, 9, 24, 9, 50, 58, 64, DateTimeKind.Utc).AddTicks(1269)
                        });
                });
            ...
            modelBuilder.Entity("SeniorLearn.Data.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Registered = new DateTime(2024, 9, 24, 9, 50, 58, 64, DateTimeKind.Utc).AddTicks(1173),
                        ...
                        new
                        {
                            ...
                            PhoneNumberConfirmed = false,
                            Registered = new DateTime(2024, 9, 24, 9, 50, 58, 64, DateTimeKind.Utc).AddTicks(1187),
                        ...
                        new
                        {
                            ...
                            PhoneNumberConfirmed = false,
                            Registered = new DateTime(2024, 9, 24, 9, 50, 58, 64, DateTimeKind.Utc).AddTicks(1200),
